...
export function ActivityLogPath() {
  return window['go']['main']['App']['ActivityLogPath']();
}
...
export function ApplicationDataDirectory() {
  return window['go']['main']['App']['ApplicationDataDirectory']();
}
...
export function AuthUpdateAvatar(arg1) {
  return window['go']['main']['App']['AuthUpdateAvatar'](arg1);
}
...
export function OpenApplicationDataDirectory() {
...
export function SharingProjectShares() {
  return window['go']['main']['App']['SharingProjectShares']();
}
